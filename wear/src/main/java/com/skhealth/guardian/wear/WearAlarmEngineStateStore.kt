...
/**
 * Durable Wear-side alarm-engine state. The state is tied to the active threshold configuration
 * so a settings change cannot resurrect a latch/counter that was created under different rules.
 */
object WearAlarmEngineStateStore {
    private const val PREF = "wear_alarm_engine_state"
    private const val KEY_SIGNATURE = "signature"

    fun signature(config: AlarmConfig): String = listOf(
