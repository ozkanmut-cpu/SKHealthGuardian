...
class MainActivity : Activity() {
    ...
    private fun showStatus() {
        ...
        android.app.AlertDialog.Builder(this).setTitle("Self-test").setMessage("Saat: ${WatchStatusStore.status(this)}\nSon self-test: $time\nSon veri: $lastTime\nSMS izni: ${has(Manifest.permission.SEND_SMS)}\nArama izni: ${has(Manifest.permission.CALL_PHONE)}").setPositiveButton("Tamam", null).show()
    }
